...
public class Branch extends Call {
	
	private final String conditionVariable;
	private final String antiTarget;
	
	public Branch(String conditionVariable, String target, String antiTarget) {
		super(target);
	...
	public void execute(Code code) throws LangarionError {
		if(this.conditionVariable == null || code.var(this.conditionVariable, true).asBoolean()) {
			...
			if(this.antiTarget != null) {
				code.call(this.antiTarget);
			}
		}
	}
}
