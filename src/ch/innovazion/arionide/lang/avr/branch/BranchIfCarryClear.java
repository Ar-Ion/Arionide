...
public class BranchIfCarryClear extends AbstractBranch {
	...
	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brcc").withColor(0.79f).withComment("Branches if the carry flag is cleared in SREG");
	}
