...
public class BranchIfNotEqual extends AbstractBranch {
	...
	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brne").withColor(0.77f).withComment("Branches if the zero flag is cleared in SREG");
	}
