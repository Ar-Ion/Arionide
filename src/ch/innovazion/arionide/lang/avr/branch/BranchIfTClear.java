...
public class BranchIfTClear extends AbstractBranch {
	...
	protected boolean isConditionMet(Environment env) throws EvaluationException {
		...
		return (sreg & 0b1000000) == 0;
	}

	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brtc").withColor(0.89f).withComment("Branches if the T flag is cleared in SREG");
	}
