...
public class BranchIfSameOrHigher extends AbstractBranch {
	...
	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brsh").withColor(0.8f).withComment("Branches if the carry flag is cleared in SREG");
	}
