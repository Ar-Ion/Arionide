...
public class BranchIfInterruptsEnabled extends AbstractBranch {
	...
	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brie").withColor(0.92f).withComment("Branches if the interrupt flag is set in SREG");
	}
