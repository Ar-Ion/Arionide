...
public class BranchIfTSet extends AbstractBranch {
	...
	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brts").withColor(0.88f).withComment("Branches if the T flag is set in SREG");
	}
