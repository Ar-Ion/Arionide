...
public class BranchIfOverflowClear extends AbstractBranch {
	...
	protected boolean isConditionMet(Environment env) throws EvaluationException {
		...
		return (sreg & 0b1000) == 0;
	}

	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brvc").withColor(0.91f).withComment("Branches if the carry flag is cleared in SREG");
	}
