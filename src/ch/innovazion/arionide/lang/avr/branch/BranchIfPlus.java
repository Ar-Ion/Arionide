...
public class BranchIfPlus extends AbstractBranch {
	...
	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brpl").withColor(0.83f).withComment("Branches if the negative flag is cleared in SREG");
	}
