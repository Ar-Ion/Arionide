...
public class BranchIfCarrySet extends AbstractBranch {
	...
	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brcs").withColor(0.78f).withComment("Branches if the carry flag is set in SREG");
	}
