...
public class BranchIfHalfCarrySet extends AbstractBranch {
	...
	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brhs").withColor(0.86f).withComment("Branches if the half carry flag is set in SREG");
	}
