...
public class BranchIfMinus extends AbstractBranch {
	...
	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brmi").withColor(0.82f).withComment("Branches if the negative flag is set in SREG");
	}
