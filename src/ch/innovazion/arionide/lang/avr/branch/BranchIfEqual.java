...
public class BranchIfEqual extends AbstractBranch {
	...
	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("breq").withColor(0.76f).withComment("Branches if the zero flag is set in SREG");
	}
