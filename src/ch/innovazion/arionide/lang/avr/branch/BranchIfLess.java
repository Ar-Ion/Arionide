...
public class BranchIfLess extends AbstractBranch {
	...
	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brlt").withColor(0.85f).withComment("Branches if the sign flag is set in SREG");
	}
