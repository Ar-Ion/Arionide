...
public class BranchIfHalfCarryClear extends AbstractBranch {
	...
	protected boolean isConditionMet(Environment env) throws EvaluationException {
		...
		return (sreg & 0b100000) == 0;
	}

	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brhc").withColor(0.87f).withComment("Branches if the half carry flag is cleared in SREG");
	}
