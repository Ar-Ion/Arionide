...
public class BranchIfGreaterOrEqual extends AbstractBranch {
	...
	protected boolean isConditionMet(Environment env) throws EvaluationException {
		...
		return (sreg & 0b10000) == 0;
	}

	protected IncompleteModel getModelDraft() {
		return StructureModelFactory.draft("brge").withColor(0.84f).withComment("Branches if the sign flag is cleared in SREG");
	}
