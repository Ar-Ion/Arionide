...
public class InterruptClear extends Instruction {
	...
	public StructureModel createStructureModel() {
		return StructureModelFactory
			.draft("cli")
			.withColor(0.59f)
			.withComment("Clears the interrupt bit in the SREG register")
