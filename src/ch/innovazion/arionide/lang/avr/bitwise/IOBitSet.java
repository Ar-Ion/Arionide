...
public class IOBitSet extends Instruction {
	...
	public StructureModel createStructureModel() {
		return StructureModelFactory
			.draft("sbi")
			.withColor(0.4f)
			.withComment("Sets the specified bits in the I/O register")
			.beginSignature("default")
			.withParameter(new Parameter("Destination").asConstant(AVREnums.IO))
			.withParameter(new Parameter("Bit number").asConstant(AVREnums.OR_BIT_MASK))
			.endSignature()
			.build();
	}
