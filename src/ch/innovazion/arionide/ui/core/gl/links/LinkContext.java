...
public class LinkContext implements Context {
	...
	public LinkContext(GL4 gl, int shader) {
		...
		this.colorUniform = gl.glGetUniformLocation(shader, "color");
		this.ambientFactorUniform = gl.glGetUniformLocation(shader, "ambientFactor");
	}
	...
	protected int getColorUniform() {
		return colorUniform;
	}

	protected int getAmbientFactorUniform() {
		return ambientFactorUniform;
	}
}
